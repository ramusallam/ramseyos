    ...
    <div className="max-w-3xl px-4 sm:px-8 pt-8 sm:pt-10 pb-20">
      <header className="mb-10">
        ...
        <div className="flex items-center gap-3 mt-3">
          <Link href="/calendar" className="text-[11px] text-muted hover:text-muted/60 transition-colors">
            Calendar &rarr;
          </Link>
      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <div className="space-y-2">
            {/* Google Calendar */}
            <div className="rounded-xl border border-border bg-surface backdrop-blur-sm p-4 flex items-center gap-4">
              <div className="size-8 rounded-lg border border-border bg-white/5 flex items-center justify-center shrink-0">
            ...
            <div className="rounded-xl border border-border bg-surface backdrop-blur-sm p-4 flex items-center gap-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-[11px] text-muted">Auth, Firestore, Storage</p>
              </div>
              <span className="inline-flex items-center gap-1.5 text-[10px] text-emerald-400/70">
                <span className="size-1.5 rounded-full bg-emerald-400" />
                Active
            ...
            <div className="rounded-xl border border-border bg-surface backdrop-blur-sm p-4 flex items-center gap-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-[11px] text-muted">Hosting &amp; deployment</p>
              </div>
              <span className="inline-flex items-center gap-1.5 text-[10px] text-emerald-400/70">
                <span className="size-1.5 rounded-full bg-emerald-400" />
                Active
          ...
          <div className="rounded-xl border border-border bg-surface backdrop-blur-sm p-5 space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-[11px] text-muted">Show the Daily Card on the Today dashboard</p>
              </div>
              <span className="inline-flex items-center gap-1.5 text-[10px] text-emerald-400/70">
                <span className="size-1.5 rounded-full bg-emerald-400" />
                Active
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-[11px] text-muted">Include life &amp; admin items in daily context</p>
              </div>
              <span className="inline-flex items-center gap-1.5 text-[10px] text-emerald-400/70">
                <span className="size-1.5 rounded-full bg-emerald-400" />
                Active
        ...
        <section>
          ...
          <div className="rounded-xl border border-border bg-surface backdrop-blur-sm p-5 space-y-3">
            <div className="flex items-center justify-between">
